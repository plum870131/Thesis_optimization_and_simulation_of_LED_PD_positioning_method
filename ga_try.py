...
# set environment
    ...
    testp_rot = np.array([[np.pi,0,0],[np.pi,np.deg2rad(15),0]]).T
...
model=ga(function=solve_mulmul,dimension=1,variable_type='real',variable_boundaries=varbound)
